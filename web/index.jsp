		...
		<div class="price-off">
			...
			<ul class="product clearfix">
				<c:forEach var="selling" items="${sellingList}">
					<li>
						<dl>
							<dt><a href="/selling.do?id=${selling.ep_id}&flag=detil" target="_blank"><img src="images/product/${selling.ep_picture}" /></a></dt>
			...
			<div class="news-list">
				...
				<ul>
					<c:forEach var="notices" items="${noticesList}">
						<li><a href="news-view.jsp?id=${notices.en_id}" target="_blank">${notices.en_title}</a></li>
					</c:forEach>
				</ul>
			</div>
			<div class="spacer"></div>
